...
- [x] 6.11.1: RecurrenceForm コンポーネント統合
- [x] 6.11.2: 繰り返し有効/無効トグル実装
- [x] 6.11.3: フォーム送信時に繰り返し設定を含める

### Task 6.12: TodoItem に繰り返しアイコン追加

- [x] 6.12.1: 繰り返しタスクの場合、アイコン表示
- [x] 6.12.2: ツールチップで繰り返し設定表示
...
- [x] 6.14.1: 繰り返しアイコンのスタイル
- [x] 6.14.2: 繰り返し設定フォームのスタイル
